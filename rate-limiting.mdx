...
If your application requires a login the configured test user is used for the agent discovery as well as for all the test runs. This could also lead to 
"hitting a limit of allowed logins", depending on your login system. If you are using a 3rd party login service, there are most likely security configurations

...
We will [execute your generated test cases](/get-started/execute-tests) and create several test reports containing your test results. These will ensure that they successfully pass when executed on your site.
...
## Go to test cases to generate more tests
...
Use AI autogeneration to [generate more test cases](/build-tests/autogenerate-tests) based off existing ones or prompt our AI agent [to create new ones](/build-tests/prompt-agent).

If you are happy with the test cases we generated for you, you can [set up scheduling](/run-tests/execution-scheduled) to periodically run your tests and ensure your site doesn't break.

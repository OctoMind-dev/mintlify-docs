...
See [API Reference](/api/api-overview)

### Blocking your pipeline

You can block your pipeline by polling the resulting test-report until the status is "PASSED" with a call to the test report API - see our [API Reference](/api/api-overview).

See the [API Reference](/api/api-overview) or a reference implementation in our [Github Action](https://github.com/OctoMind-dev/automagically-action-execute/blob/main/src/executeAutomagically.ts#L107)

...
start from a prompt or existing steps unsing the `record from here` button.
...
<Frame caption="`Record from here` button to launch Octomind recorder, 04/2025">
  <img
    src="/images/recorder/recorder-test-detail.png"
    alt="record from here button in the octomind app to launch Octomind recorder"
  />
</Frame>

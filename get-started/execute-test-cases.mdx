...
You can use the `global step timeout` in the [environment settings](/account-view/environments) to shorten the timeout between steps if you want to run the tests faster. Our default is 30 seconds. This option should be enjoyed with caution - it can lead to more frequent failures due to timing issues.

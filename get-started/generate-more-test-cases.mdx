...
Help the Agent when it couldn't quite nail the auto-generation - **yellow alert** highlights a failed step generation. See how you [help the Agent to generate a test case successfully](/guides/help-agent-succeed).

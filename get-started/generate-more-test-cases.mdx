...
Help the Agent when it couldn't quite nail the auto-generation - **yellow alert** highlights a failed step generation. See how in the [edit test case](/get-started/edit-test-case) section.

<Frame caption="New generated tests, 10/2024">
  <img src="/images/expand/new-generated-tests.png" alt="New generated tests" />
</Frame>

It's possible that the Agent fails to generate a test ([here are some reasons why](/guides/agent-fails)) or needs help with something. This is how you [edit a yellow test case](/get-started/edit-test-case) to nudge the Agent into the right direction.

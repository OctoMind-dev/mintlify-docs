...
We generate tests on [sign-up](/get-started/first-steps#4-open-the-octomind-app-for-the-first-time), when [we auto-generate 3 initial test cases](/get-started/first-steps#5-we-are-auto-generating-test-cases-for-you) and when you ask our AI agents to [generate more](/get-started/generate-more-test-cases) tests.
...
Our open source tool [Debugtopus](https://github.com/OctoMind-dev/debugtopus) can pull the latest test case from our repository and execute it against your local environment. [Learn how.](/get-started/debugtopus)
...
See [our section about prompting a new test case](get-started/new-test-case#free-prompting-best-practices).
...
You can also run us [programmatically without using a CI](/get-started/execution-without-ci), schedule regular test runs or trigger test runs manually.

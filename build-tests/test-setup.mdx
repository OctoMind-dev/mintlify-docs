...
If your application requires a user to be logged in to access most of its functionality, you'd need your tests to login. Check out how to set up [basic authentication](/advanced/basic-authentication) or [OTP](/advanced/2fa) including[email flows](/advanced/email-flows.mdx).

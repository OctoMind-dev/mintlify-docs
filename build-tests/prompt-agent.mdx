...
<Frame caption="Create new test case by prompting the AI agent, 07/2024">
  <img
...
<Frame caption="AI Agent informs about the progress of test step generation, 07/2024">
  <img
    ...
    alt="AI Agent informs about the progress of test step generation"
  />
</Frame>
...
<Frame caption="AI agent needs help your input to finalize generation - click repair test, 05/2025">
  <img
    src="/images/build/repair-yellow-test.png"
    alt="AI agent needs your input to finalize generation - click repair test"
  />
</Frame>

Follow the instuction of the Agent to repair the test.
...
Go to `environments` menu item in the left project menu bar and click on the `default environment` in the list. You can have separate login test for separate environment.
...
<Frame caption="Add test user credentials for login test generation in authentication tab of the environments settings, 05/2025">
  <img
    src="/images/build/pre-prompted-login-test.png"
    alt="Add test user credentials for login test generation in authentication tab of the environments settings"
    width="500"
  />
</Frame>
...
4. These are the limitations so far:
   ...
   - The Agent might not support required type of interaction & assertion yet. [Manual intervention will be necessary.](/get-started/edit-test-case.mdx)

...
- exclude test cases from running per environment
- new **drag'n'drop** step
- new **hover** step
- variables can be used in entry path url (where the test case starts)
- **arrow keys** are now available in "key press" steps

### 2025-01-07

- new environment page
- per environment configurable variables
- new test case overview with timeline
- improved url check on project create / test case execution

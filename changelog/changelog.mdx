...
- **Smoother autoplay**: Enhanced autoplay functionality with restart capabilities for better test flow
...
- **Debug rail navigation**: Direct navigation to debug rail for enabled test cases (Octoneer only)
...
- **Discovery chat**: Added chat interface for test discovery process with frontend implementation

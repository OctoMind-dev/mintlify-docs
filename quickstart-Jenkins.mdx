...
<Warning>
  If you already have a way to trigger your pipeline, you can skip this step
</Warning>
...
You should copy that code to the desired step in your pipeline.
...
<Tip>AUTOMAGICALLY_TOKEN is API key created in [first step](#1-create-an-api-key).</Tip>
...
<Frame caption="Enabling safe parsing of HTML, Jenkins 2.401.2">
  <img src="/images/Jenkins-06.png" alt="Enabling safe parsing of HTML" />
</Frame>

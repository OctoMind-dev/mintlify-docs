...
2. check the **prompt** - if it's not valid anymore, adjust it
3. click `regenerate steps`
4. select the first step that broke
5. confirm `generate steps`

The **AI agent** will is re-generate steps of your test and validate them. If it's alright, click `save & run`. If it needs adjustment, this is [how you edit test cases](/edit-test-case.mdx).

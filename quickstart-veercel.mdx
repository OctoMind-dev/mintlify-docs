...
<Info>
  If you are using Github Actions workflow to deploy to Vercel with your own
...
See also our [example vercel-actions integration repo](https://github.com/OctoMind-dev/vercel-actions-example).

...
We are using our AI agent for test case discovery. We create the first selection of test cases at your set-up automatically. We'll discover the interaction chain of the test case in an intermediate representation.
You'll be able to add more user flows that need to be end-to-end tested by using our [AI agent](/discovery) or a [Playwright recorder](/recorder) in the app.
We'll generate a corresponding Playwright code on the fly and execute it against your **pull request**.

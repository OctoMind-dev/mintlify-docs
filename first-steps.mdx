...
<div
  style={{
    position: "relative",
    paddingBottom: "calc(55.43121693121693% + 42px)",
    height: 0,
  }}
>
  <iframe
...
## 7. Publish your test cases

Once our AI agent has finished generating steps, you can publish the test case to disable editing and run it in your [Test Reports](/test-reports)

...
At the first set-up, you can select if we should auto-generate:
...
Octomind will discover test cases on your page according to how your website looks.
...
## 5. Publish your test cases

Once our AI agent has finished generating steps, you can publish the test case to disable editing and run it in your <a href="/test-results">Test Reports</a>

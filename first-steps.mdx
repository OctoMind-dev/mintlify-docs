...
<Frame caption="Button to add more test cases, screenshot 01/2024">
  <img
...
<Frame caption="Test cases screen button to add test cases using a recorder, screenshot 10/2023">
  <img
    src="images/setup/setup-7-recorder.png"
    alt="test cases screen button to add test cases using a test recorder"
  />
</Frame>

...
<Info>
  We are triggering a test case discovery for the <b>sign-in</b> flow and do a
  <b> reachability</b> check for all your links right away. You will get your
  first test cases within minutes. If the discovery of the sign-in test fails,
  we will investigate. This might take a little longer.
</Info>

We will ask you for the most useful test cases, and we'll create 3 to 8 of them.
We will notify you once we are done with the test case creation. Or you can try out our **brand-new free prompting feature**!

## 5. ALPHA: Free prompt more test discoveries

We've added a new feature for creating test cases using free prompting. It's still in alpha. Experiment and let us know your thoughts!
...
## 5. Record missing test cases manually

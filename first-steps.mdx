...
The second page will render a screenshot of the url you provided. We chexk if it is accessible. You can name your project now. We'll propose one similar to the url you provided.
...
## 5. Discover your test cases

Here comes the really cool part. You can let the AI agent to through your app and discover more tests. Click on `discover`.

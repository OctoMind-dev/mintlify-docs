...
From the [test report](/account-view/test-reports), go to the **debug** tab of your test result and launch the **trace viewer**.
...
Our open source [Debugtopus](/get-started/debugtopus) is an additional help that allows you to set breakpoints and step through the code.

## Correct the broken test steps

This applies when your app works as intended, but the test fails to run. Use our editing tools to quickly add, remove steps or adjust locators. Here is how you [edit test cases](/get-started/edit-test-case).
...
The **AI agent** will re-generate steps of your test and validate them. If it's alright, click `save & run`. If it needs adjustment, this is [how you edit test cases](/get-started/edit-test-case).
...
## Try the new AI auto-fix beta version

Try our newly released [beta version for auto-maintenance](/maintain/auto-fix) and have the AI Agent attempt to fix your test.

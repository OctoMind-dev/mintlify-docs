...
This is how to proceed when you [diagnosed a broken test](/maintain/maintain-tests.mdx).
...
- decline the auto-fix and [edit the test steps manually](/get-started/edit-test-case)

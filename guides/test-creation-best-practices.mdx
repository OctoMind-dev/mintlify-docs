---
title: Test creation best practices
...
You can have the AI agent generate more test cases. Go into the test case and hover over the `generate more` icon - a button will appear. Click on it. Find more on how `generate more` works [here](/get-started/generate-more-test-cases).
...
At sign-up, we automatically auto-generate **close cookie banner** and **"required" login** test cases. These are often the necessary prerequisites for all other tests. [Learn more.](/get-started/first-steps#4-open-the-octomind-app-for-the-first-time)
...
More details can be found in the [editing test cases](/get-started/edit-test-case) section.
...
You can find the `run locally` button in the `debug` tab of your test case. Find out how to [run Octomind tests locally](/get-started/debugtopus).

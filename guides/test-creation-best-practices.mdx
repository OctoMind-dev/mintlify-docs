...
You can have the AI agent generate more test cases. Go into the test case and hover over the `generate more` icon - a button will appear. Click on it. Find more on how `generate more` works [here](/build-tests/autogenerate-tests).
...
More details can be found in the [editing test cases](/get-started/edit-tests) section.

...
After the test case execution is triggered we will use a bash script to monitor the progress. This is rather simple as we can just use the apps API to look for tasks and their status.

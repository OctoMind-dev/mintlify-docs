...
In the [first part of the test debugging guide](/guides/test-debugging-1.mdx) we have learned what can cause the failure of an Octomind test. Now, we'll show you how to debug specific use cases, starting with fixing a prompt.

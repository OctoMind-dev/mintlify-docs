...
You can block your pipeline by polling the resulting test-report until the status is "PASSED" with a call to the test report API available at `/api/apiKey/v2/test-targets/{testTargetId}/test-reports/{testReportId}`.

...
<Frame caption="generate a test report from the terminal, screenshot 02/2024">
  <img src="/images/rerun-in-cli-modal.png" alt="modal to retrieve the curl command" />
</Frame>

You can see how to set up your `API key` below.

The command will return a response with link to your test report, looking like this:

```JSON
{ "testReportUrl": "https://app.octomind.dev/testreports/<some-id>" }
```

In this link, you can find the test report containing all test results of your execution.

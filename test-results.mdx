...
| status      | checkmark: successfuly executed; hourglass: execution in progress; red cross: test case failed; broken heart: test case execution error |
...
<Frame caption="Test result page for a successful test case, screenshot 09/2023">
  <img

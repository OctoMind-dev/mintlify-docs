...
A Playwright code is generated on the fly just before test execution.

## Free prompting

We have beta released our free prompting interface for everyone to try it out. It will helps us fine tune the AI agent and the self-serve experience.
...
<Info>
  ...
  test creation effort is minimal self-healing fully automated. Prompting will
  become fully automated for more and more test cases as we go.
</Info>

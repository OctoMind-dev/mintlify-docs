...
<Frame caption="Free prompting window for test case discovery, screenshot 10/2023">
  <img
...
When using the AI agent to discover your tests, you can use a dependency to chain them together. Shorter flows are faster, more specific and more reliable.

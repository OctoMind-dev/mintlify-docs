...
When creating a new test case, you need to provide it with the name and optionally, the starting endpoint.
Starting endpoint helps when your test does not start at the homepage, rather in some specific route.
This way we reduce the boilerplate needed to navigate to the place you actually want to test.

<Frame caption="?, screenshot 02/2024">
  <img src="/images/test-case/draft/create-test-case.png" />
</Frame>
...
<Frame caption="caption goes here">
  <img src="/images/test-case/draft/create-test-case-2.png" />
</Frame>
...
For example, your app requires login, therefore instead including "first perform a login" to your prompt, you can preselect the login test, assuming you created that test case before.
...
<Frame caption="caption goes here">
  <img src="/images/test-case/draft/create-test-case-dependency.png" />
</Frame>

You can enter the desired prompt into the text field.

<Frame caption="caption goes here">
  <img src="/images/test-case/draft/enter-prompt.png" />
</Frame>

Clicking the save button will put you in steps rail and trigger our AI Agent to start generating test case steps.
This may take a while, but step generation this way is streamed so you can see (needs wording)

<Frame caption="caption goes here">
  <img src="/images/test-case/draft/after-pressing-save.png" />
</Frame>

(Some ex-agent-reasoning explanation goes here)

<Frame caption="caption goes here">
  <img src="/images/test-case/draft/finished-step-generation.png" />
</Frame>
...
If there is something wrong in syntax, your save action will be rejected.
...
For this example, lets purposely make a typo in our quick example, by typing `clik` instead of `click`:

(screenshot-goes-here)

Once the syntax is valid, clicking the save button will instantly create a draft.

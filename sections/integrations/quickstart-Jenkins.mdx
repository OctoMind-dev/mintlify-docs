...
<Frame caption="Adding webhook to repository, screenshot 07/2023">
  <img
    src="/images/ci-integrations/jenkins/Webhook-01.png"
...
<Frame caption="Configuring webhook, screenshot 07/2023">
  <img
    src="/images/ci-integrations/jenkins/Webhook-02.png"
...
<Frame caption="Configuring webhook permissions, screenshot 07/2023">
  <img
    src="/images/ci-integrations/jenkins/Webhook-03.png"
...
<Frame caption="Validating webhook, screenshot 07/2023">
  <img
    src="/images/ci-integrations/jenkins/Webhook-04.png"
...
<Frame caption="Configuring AUTOMAGICALLY_TOKEN, Jenkins 2.401.2">
  <img
    src="/images/ci-integrations/jenkins/Jenkins-06.png"
...
<Frame caption="Enabling safe parsing of HTML, Jenkins 2.401.2">
  <img
    src="/images/ci-integrations/jenkins/Jenkins-07.png"
...
<Frame caption="Creating new Pipeline, Jenkins 2.401.2">
  <img
    src="/images/ci-integrations/jenkins/Jenkins-01.png"
...
<Frame caption="Creating new Pipeline, Jenkins 2.401.2">
  <img
    src="/images/ci-integrations/jenkins/Jenkins-02.png"
    alt="Creating new Pipeline"
  />
</Frame>
...
<Frame caption="Configuring triggers from GitHub webhook, Jenkins 2.401.2">
  <img
    src="/images/ci-integrations/jenkins/Jenkins-03.png"
...
<Frame caption="Loading Jenkinsfile from GitHub repository, Jenkins 2.401.2">
  <img
    src="/images/ci-integrations/jenkins/Jenkins-04.png"
...
<Frame caption="Loading Jenkinsfile from GitHub repository, Jenkins 2.401.2">
  <img
    src="/images/ci-integrations/jenkins/Jenkins-05.png"
    alt="Loading Jenkinsfile from GitHub repository"
  />
</Frame>

...
It gives you all the necessary info to inspect broken test and fix the app or your test, depending on what caused it. [This is how you do it.](/maintain-tests/inspect-broken-tests)
...
In the `maintain tests` section of this documentation, we explain [why tests fail](/maintain-tests/why-tests-fail), how you [inspect the cause](/maintain-tests/inspect-broken-tests) and how you can [fix broken tests](/maintain-tests/auto-fix).

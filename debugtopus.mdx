...
Now change the placeholder **local-url** with the url of your local environment. In the example screenshot below the placeholder was replaced with *localhost:3000*. You might also have to include the route to the starting point. If your testcase assumes to run from the sign-in page you might have to add the route to the sign-in page e.g. *localhost:3000/signin*.

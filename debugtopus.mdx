...
Debugtopus is our open source tool enabling you to run tests locally for easier debugging. Follow the steps below to
...
Now change the placeholder **local-url** with the url of your local environment. In the example screenshot below
the placeholder was replaced with _localhost:3000_. You might also have to include the route to the starting point.
If your testcase assumes to run from the sign-in page you might have to add the route to the sign-in page

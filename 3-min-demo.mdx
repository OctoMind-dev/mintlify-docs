...
You can [try it right now](app.octomind.dev) by setting up your first user flow at app.octomind.dev.
...
## 2. User flow discovery

Full disclosure - we auto-discover only **sign-in** user flow for now. We will keep you posted as we are continuously adding new user flows.

...
- a **log-in** user flow
- a **change language** flow
- a **reachability** check for all links on your page
- or just go with custom test cases, where you can create test cases
  - with our [AI Agent](/discovery) \(alpha feature\)
  - with the `Playwright recording`
...
<Frame caption="Free promting window for test case discovery, screenshot 10/2023">
  <img

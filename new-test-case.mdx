...
Our AI agent will discover up to 3 new tests following up on the test case you launched it from. The original test will be added as a **dependency** automatically. It will auto-generate steps for every discovered test case and validate them.

The AI agent status indicator will display what's going on.

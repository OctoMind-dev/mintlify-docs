...
The fastest way to create a new test case is to have it AI generated. You give us a short prompt and we deploy our `AI agent` to find the interactions leading towards a desired user flow.
...
3. **Add, edit and remove steps manually.** Our virtual locator picker helps you edit tests in no time.

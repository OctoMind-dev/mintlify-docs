...
<Frame caption="Octomind Azure Flow">
  <img
    src="/images/integrations/azure/Octomind-Azure-flow.jpg"
    alt="GitHub flow"
  />
</Frame>
...
<Frame caption="Octomind Azure install, screenshot 06/2023">
  <img
    src="/images/integrations/azure/azure-install.png"
...
<Frame caption="Octomind Azure pipeline permissions, screenshot 06/2023">
  <img
    src="/images/integrations/azure/azure-permissions.png"
...
<Frame caption="Example of Octomind test results in a pull request comment, screenshot 07/2023">
  <img
    src="/images/integrations/azure/dev.azure.com_octomind-dev_test-pipeline-task__git_test-pipeline-task_pullrequest_1.png"

...
inputs. We are also using screenshots. This doesn't require access to your code base. We are only seeing those parts of your app
which are exposed to your users anyways.
Hence we are not jepordizing any SOC2 or ISO compliance requirements you might need to follow.
...
In case you need to exclude our agent from your metrics you can easily do this by excluding any browsers with a browser name

...
You might want to integrate Octomind into your development workflows. To do so, you can use our various [CI/CD integrations](/integrations-overview).
...
Our GitHub and Azure DevOps integration are bi-directional. They trigger test runs and comment results back into your pull requests.

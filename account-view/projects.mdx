...
You can run your test **against a different URL** while keeping the sub paths - the URL is "templated". This allows you to [run your test cases against multiple deployments](/get-started/execute-test-cases#1-trigger-a-test-run) of the same application.

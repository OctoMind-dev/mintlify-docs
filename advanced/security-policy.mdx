...
We value the contributions of security researchers who help us maintain a secure platform. Our security team will determine appropriate rewards based on a comprehensive assessment of each reported vulnerability.

The reward amount will be evaluated considering:

- Vulnerability criticality and severity
...
Vulnerabilities are categorized by severity levels ranging from **Low** (minor security misconfigurations) to **Critical** (remote code execution, privilege escalation). All reward decisions are at the sole discretion of Octomind's security team.

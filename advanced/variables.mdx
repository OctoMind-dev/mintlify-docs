...
- `$OCTO_EMAIL`: email address for 2 factor [email flows](/advanced/email-flows).
- `$OCTO_EMAIL_DOMAIN`: domain of the email address for 2 factor [email flows](/advanced/email-flows).
- `$OCTO_EMAIL_PREFIX`: prefix of the email address for 2 factor [email flows](/advanced/email-flows).

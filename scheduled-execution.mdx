...
If you don't have CI pipelines but you would like to run your tests on a regular schedule, you can do that via our scheduling feature in the `test reports` section of the project overview page.

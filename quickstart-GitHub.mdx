...
description: "Run a GitHub Action to get Octomind test results into your commit comments"
icon: "github"
---
...
<Frame caption="Octomind GitHub Action intstall, screenshot 06/2023">
 <img src="/images/Octomind-GitHub-Action-install-screenshot.png" alt="Octomind GitHub Action intstall" />
</Frame>

3. We’ll ask you to grant access to your repository to read metadata & read and write access to pull requests so we are allowed to comment back into the pipeline. It will list the test results with additional links to more details, looking like this ↓

...
- `shadow DOM and iFrames` - the AI agent can hangle most shadow DOMs and iFrames now
...
- `AI discovery`: we automatically run, generate steps and code, and validate all successfully discovered test cases and publish them to your test suite.

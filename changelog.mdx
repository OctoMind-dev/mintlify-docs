...
- You can edit test cases, now. Delete steps in test cases or mark them as optional, so their failure is ignored. Enter text parameters. Create test case drafts and publish them. Archive test cases. Create new drafts from archived tests when needed.

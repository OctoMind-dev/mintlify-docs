...
- `improved stability`: (not sure how to explain here)
- `discover test cases`: our AI Agent will analyse your webpage and suggest multiple prompts which describe your test flows

<Frame caption="screenshot 02/2024">
  <img src="images/changelog/discover-screen.png" alt="new discovery feature" />
</Frame>

- `approval workflow`: once our AI Agent has finished the discovery, you have an option to approve or discard provided suggestions.
  Discarding will delete the draft, while approval will give the prompt to our AI Agent to start generating steps from it

<Frame caption="screenshot 02/2024">
  <img src="images/changelog/approval-screen.png" alt="new discovery feature" />
</Frame>
...
- save rail overhaul:
  ...
  - we replaced save rail with the functionalities that were inside it. Now we have 3 separate buttons

  1. save button: to save changes made
  2. run button: to run the selected test case
  3. publish button

  run button is also visible in on published test cases

<Frame caption="screenshot 02/2024">
  <img src="images/changelog/save-rail-overhaul.png" alt="save rail overhaul" />
</Frame>
